...
>
> **Et le DevOps est l'endroit où les deux se rejoignent.** Une chaîne de livraison bien tenue trace qui a modifié quoi, empêche de déployer sans passer les tests et gère les secrets : c'est de la conformité rendue opérationnelle. J'ai fait un M1 en ingénierie logicielle avant mon M2 en cybersécurité, et c'est ce qui me permet de traiter la sécurité là où elle se joue, dans le code et dans la chaîne de livraison.
>
> Six mois chez **Volkswagen Financial Services**, au département Juridique et Conformité, en interface quotidienne avec les équipes IT : conformité RGPD, **registre des traitements sous DASTRA**, et revues de sécurité des prestataires (TPRM). Autant de contexte concret sur ce que les équipes techniques ont pour mission de protéger.
>
> Ce que vous trouverez sur ce GitHub : une **chaîne CI/CD cassée volontairement quatre fois** avec son journal des pannes, des labs SOC construits avec Splunk et Sysmon, des scénarios de détection basés sur MITRE ATT&CK, des write-ups d'alertes, et des labs de pentest pour comprendre les techniques d'attaque avant de les détecter. La GRC est documentée à travers un SMSI ISO 27001 complet sur un scénario HealthTech fictif.
>
...
>
> Je recherche activement un premier poste en **CDI** : **DevOps / CI-CD**, **SOC** ou **GRC technique**, en France.
...
<a href="https://certs.ine.com/f65bae77-9d66-41c3-89cc-f3d583e01b0c#acc.k3JEMWGO">
  <img width="150" alt="Certification eJPT" src="https://github.com/user-attachments/assets/c5a4790c-3ccf-4a56-b607-46ed748335ad" />
</a>
...
<sub>
Diplômé d'un Master 2 Cybersécurité à l'Université de Rennes 1, après un M1 en ingénierie du logiciel à Avignon et une licence d'informatique à Angers.
6 mois d'expérience chez Volkswagen Financial Services en conformité RGPD, registre des traitements et revues de sécurité des prestataires.
</sub>
</div>
---
...
[![NIST 800-53](https://img.shields.io/badge/NIST_800--53-1A5276?style=flat-square)](https://www.kiteworks.com/fr/glossaire/nist-800-53-compliance/)
...
| [GRC_Projects](https://github.com/juniorabakar/GRC-projects) | `EN COURS` | SMSI ISO 27001 · NIST CSF |
